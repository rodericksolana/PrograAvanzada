...
void imprimir(Barco *, Persona *, int, int);
...
void agregarBarco(Barco *b, int a)
{
	int aux=0;
	   ...
	   printf("Dame el nombre: ");
           scanf("%s",(b+a)->nombreB);
	   //(b+a)->eslora = malloc(sizeof(float)*10);
	   printf("Dame la eslora: ");
	   scanf("%f",&(b+a)->eslora);
	   //(b+a)->manga = malloc(sizeof(float)*10);
	   printf("Dame la manga: ");
	   scanf("%f",&(b+a)->manga);
	   //(b+a)->nMax = malloc(sizeof(int)*10);
...
void agregarPersona(Persona *p, int a)
{
	   ...
	   printf("Dame el rol: ");
      	   scanf("%s",(p+a)->rol);
	  /* int ol=0;
	   //(p+a)->status = malloc(sizeof(int)*10);
	   (p+a)->status=ol;
*/
/*
	   (p+a)->status = malloc(sizeof(int)*10);
...
printf("Estoy en la funcion relacionar\n");
...
void imprimir(Barco *b, Persona *p, int a, int c)
{
int j=0;
 printf("Displaying Information Barcos:\n");
   for(i=0;i<a;++i)
{
       printf("ID: %d Barco:%s\t%f\t%f\t%d\n",i+1,(b+i)->nombreB, (b+i)->eslora,(b+i)->manga,(b+i)->nMax);
...
/*
   printf("Displaying Information Personas:\n");
   for(i=0;i<c;++i)
       printf("%s\t%s\t%d\t%s\t%d\n",(p+i)->nombreP,(p+i)->apellido,(p+i)->edad,(p+i)->rol,(p+i)->status);
*/
